...
def parseStudentDetailsHtmlToStudent(html):
    ...
    return Student(
        studentName=soup.find('span', id='PageContent_lblName').text,
        password="EMPTY",
        timeTaken="EMPTY",
        studentId=soup.find('span', id='PageContent_lblID').text,
        category=soup.find('span', id='PageContent_lblCategory').text,
        roll=soup.find('span', id='PageContent_lblRollNo').text,
        enrollmentNo=soup.find('span', id='PageContent_lblEnrollNo').text,
        ...
        admissionDate=soup.find('span', id='PageContent_lblAdmissionDate').text,
        studentType=soup.find('span', id='PageContent_lblStudentType').text,
        phone=soup.find('span', id='PageContent_lblContactNo').text,
        fatherName=soup.find('span', id='PageContent_lblFatherName').text,
        motherName=soup.find('span', id='PageContent_lblMotherName').text,
